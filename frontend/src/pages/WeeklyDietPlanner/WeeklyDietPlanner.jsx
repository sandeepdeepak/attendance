    ...
    <div className="min-h-screen bg-[#0a1f2e] text-white flex flex-col px-4 py-8">
        ...
        <div className="bg-[#1C2937] rounded-lg p-4">
          ...
          {weeklyPlan[activeDay]?.meals?.length === 0 ? (
            <div className="text-center py-8 text-gray-400">
              No meals added for {activeDay}. Add meals below.
            </div>
          ) : (
            <div className="space-y-4">
              {weeklyPlan[activeDay]?.meals?.map((meal, index) => (
                <div
                  key={index}
                  className="bg-[#123347] p-4 rounded-lg meal-item"
                >
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-gray-400 text-xs">
                        {meal.totalCarbs || meal.carbs}g Carbs |{" "}
                        {meal.totalFats || meal.fats}g Fats
                      </p>
                      <p className="text-gray-400 text-xs">
                        {meal.totalProteins || meal.proteins}g Proteins |{" "}
                        {meal.totalFibre || meal.fibre}g Fibre
                      </p>
      ...
      {showMealSelectionModal && (
        <div className="fixed inset-0 bg-[#0a1f2e] bg-opacity-80 flex items-center justify-center z-50 modal-overlay">
          <div className="bg-[#1C2937] p-6 rounded-lg w-full max-w-3xl modal-content">
            ...
            {!isSearching && (
              <div className="grid grid-cols-1 gap-2 max-h-[50vh] overflow-y-auto">
                {mealsToDisplay.map((meal) => (
                  <div
                    key={meal.id}
                    className="cursor-pointer hover:bg-gray-800 p-3 rounded search-result-item"
                  ...
                  >
                    <div className="flex justify-between items-center">
                      ...
                      <div className="bg-[#024a72] px-3 py-1 rounded">
